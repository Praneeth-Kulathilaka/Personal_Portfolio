...
const Hero = () => {
  return (
    <div className='border-b border-neutral-900 h-screen pb-4 lg:mb-4'>
        <div className='flex flex-wrap'>
            <div className='w-full lg:w-1/2 space-x-2 py-6'>
                <div className='flex flex-col items-center lg:items-start '>
                    <motion.h1
                        variants={container(0)}
                        initial="hidden"
                        animate="visible"
                        className='pb-6 text-2xl font-thin tracking-tight lg:mt-12 lg:text-3xl'>
                    ...
                    {/* <motion.span 
                        ...
                        initial="hidden"
                        animate="visible"
                        className='bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-6xl pb-6 tracking-tight text-transparent'>Software Developer
                    </motion.span> */}
                    <TypeAnimation
                         sequence={[
                            'Software Developer',
                          ...
                          wrapper="span"
                          speed={50}
                          className='bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-6xl pb-6 tracking-tight text-transparent'
                          repeat={Infinity}
                    >
            ...
            <div className='w-full lg:w-1/2 lg:top-0 bg-zinc-400/60 lg:h-full'>
                <div className='flex justify-center lg:py-0 h-96 '>
                    <motion.img 
